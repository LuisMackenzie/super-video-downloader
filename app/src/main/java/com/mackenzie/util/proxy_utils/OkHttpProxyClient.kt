...
class OkHttpProxyClient @Inject constructor(
    ...
    private var currentProxy: com.mackenzie.data.local.model.Proxy
    ...
    fun getProxyOkHttpClient(): OkHttpClient {
        ...
        if (proxy.host != currentProxy.host && proxy.port != currentProxy.port || (httpClientCached == null)) {
            ...
            httpClientCached =
                if (proxy == com.mackenzie.data.local.model.Proxy.noProxy()) {
    ...
    private fun getProxy(): com.mackenzie.data.local.model.Proxy {
