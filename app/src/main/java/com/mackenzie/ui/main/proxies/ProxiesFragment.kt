package com.mackenzie.ui.main.proxies
...
import com.mackenzie.data.local.model.ProxyType
import com.mackenzie.databinding.FragmentProxiesBinding
import com.mackenzie.ui.component.adapter.ProxiesAdapter
import com.mackenzie.ui.component.adapter.ProxiesListener
        ...
        dataBinding = FragmentProxiesBinding.inflate(inflater, container, false).apply {
            ...
            this.saveCustomDnsButton.setOnClickListener {
                ...
                Toast.makeText(
                    ...
                    getString(com.mackenzie.R.string.custom_dns_saved_message),
                    Toast.LENGTH_SHORT
                ).show()
