...
class PlaybackStateRepository @Inject constructor(
    ...
    fun updatePlaybackState(
        ...
        saveState(newState)
        AppLogger.Companion.d("PlaybackState updated: $newState")
    }
    ...
    private fun loadSavedState() {
        ...
        AppLogger.Companion.d("Loaded saved playback state: $savedState")
    }

    fun clearState() {
        prefs.edit().clear().apply()
        _playbackState.value = PlaybackState()
        AppLogger.Companion.d("Playback state cleared")
    }
