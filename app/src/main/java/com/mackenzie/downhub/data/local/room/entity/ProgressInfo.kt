...
import com.mackenzie.downhub.util.RoomConverter
...
data class ProgressInfo(
    ...
    var progressSize: String = ""
        get() {
            return FileUtil.Companion.getFileSizeReadable(progressDownloaded.toDouble()) + "/" + FileUtil.Companion.getFileSizeReadable(
