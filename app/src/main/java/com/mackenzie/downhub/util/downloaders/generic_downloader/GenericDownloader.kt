package com.mackenzie.downhub.util.downloaders.generic_downloader
...
abstract class GenericDownloader {
    companion object {
        ...
        fun isWorkScheduled(context: Context, uniqueWorkName: String): Boolean {
            ...
            try {
                ...
                AppLogger.Companion.e("isWorkScheduled: Error checking work status for $uniqueWorkName")
                e.printStackTrace()
    ...
    fun saveStringToSharedPreferences(
        ...
        editor.apply()
        AppLogger.Companion.d("saveHeadersStringToSharedPreferences  $workId")
    }

    fun loadHeadersStringFromSharedPreferences(context: Context, workId: String?): String? {
        AppLogger.Companion.d("loadHeadersStringFromSharedPreferences  $workId")
    ...
    fun deleteHeadersStringFromSharedPreferences(context: Context, workId: String?) {
        ...
        editor.apply()
        AppLogger.Companion.d("deleteHeadersStringFromSharedPreferences  $workId")
    }
