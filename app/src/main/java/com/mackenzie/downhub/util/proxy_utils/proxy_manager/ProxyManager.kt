package com.mackenzie.downhub.util.proxy_utils.proxy_manager

import android.util.Log
import com.mackenzie.downhub.DLApplication
import com.mackenzie.downhub.v2ray.V2Ray
 ...
 */
object ProxyManager {
    private const val TAG = "${DLApplication.Companion.DEBUG_TAG} ProxyManager"
