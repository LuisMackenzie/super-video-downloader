...
import com.mackenzie.downhub.databinding.FragmentBrowserBinding
import com.mackenzie.downhub.ui.component.adapter.WebTabsAdapter
import com.mackenzie.downhub.ui.component.adapter.WebTabsListener
...
class BrowserFragment : BaseFragment(), BrowserServicesProvider {
    ...
    private val requestPermissionLauncher = registerForActivityResult(
        ...
        AppLogger.Companion.d("Permissions for writing isGranted: $isGranted")
    }
    ...
    private val serviceWorkerClient = object : ServiceWorkerClient() {
        override fun shouldInterceptRequest(request: WebResourceRequest): WebResourceResponse? {
            ...
            if (isM3u8Check || isMp4Check) {
                ...
                val contentType = VideoUtils.Companion.getContentTypeByUrl(
    ...
    private fun createHomeTabFragment(): Fragment {
        return BrowserHomeFragment.Companion.newInstance()
    }
    ...
    override fun getPageTab(position: Int): WebTab {
        val list = browserViewModel.tabs.get() ?: listOf(WebTab.Companion.HOME_TAB)
    ...
    private fun createTabFragment(index: Int): Fragment {
        val fragment = WebTabFragment.Companion.newInstance().apply {
    ...
    private fun handleCloseWebTabEventEvent() {
        browserViewModel.closePageEvent.observe(viewLifecycleOwner) { webTab ->
            val tabs =
                browserViewModel.tabs.get()?.toMutableList() ?: mutableListOf(WebTab.Companion.HOME_TAB)
