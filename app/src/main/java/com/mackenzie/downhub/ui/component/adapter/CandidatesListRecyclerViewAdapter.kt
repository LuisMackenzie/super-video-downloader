...
import com.mackenzie.downhub.databinding.DownloadCandidateItemBinding
    ...
    override fun onBindViewHolder(holder: CandidatesViewHolder, position: Int) {
        ...
        with(holder.binding) {
            ...
            val formatSize = if (formatEntity.fileSizeApproximate > 0) {
                FileUtil.Companion.getFileSizeReadable(formatEntity.fileSizeApproximate.toDouble())
            } else if (formatEntity.fileSize > 0) {
                FileUtil.Companion.getFileSizeReadable(formatEntity.fileSize.toDouble())
            } else {
                "Unknown"
            }
