package com.mackenzie.downhub.ui.main.progress
...
import com.mackenzie.downhub.databinding.FragmentProgressBinding
import com.mackenzie.downhub.ui.component.adapter.ProgressAdapter
import com.mackenzie.downhub.ui.component.adapter.ProgressListener
...
class WrapContentLinearLayoutManager : LinearLayoutManager {
    ...
    override fun onLayoutChildren(recycler: Recycler, state: RecyclerView.State) {
        try {
            ...
            AppLogger.Companion.e("meet a IOOBE in RecyclerView")
        }
    }
}