package com.mackenzie.downhub.ui.main.home
...
import com.mackenzie.downhub.databinding.ActivityMainBinding
import com.mackenzie.downhub.ui.component.adapter.MainAdapter
...
class MainActivity : BaseActivity() {
    ...
    override fun onNewIntent(intent: Intent?) {
        ...
        if (intent?.getBooleanExtra(
                YoutubeDlDownloaderWorker.Companion.IS_FINISHED_DOWNLOAD_ACTION_KEY,
                false
            ) == true
        ) {
            if (intent.getBooleanExtra(
                    YoutubeDlDownloaderWorker.Companion.IS_FINISHED_DOWNLOAD_ACTION_ERROR_KEY,
                    false
                )
            ) {
            ...
            if (intent.hasExtra(YoutubeDlDownloaderWorker.Companion.DOWNLOAD_FILENAME_KEY)) {
                val downloadFileName =
                    intent.getStringExtra(YoutubeDlDownloaderWorker.Companion.DOWNLOAD_FILENAME_KEY)
                        .toString()
