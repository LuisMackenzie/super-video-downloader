    ...
    private fun navigateToHistory() {
        try {
            ...
            activityFragmentContainer?.let {
                ...
                transaction.add(it.id, HistoryFragment.Companion.newInstance())
                transaction.addToBackStack("history")
                transaction.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN)
                transaction.commit()
            }
        } catch (e: ClassCastException) {
            AppLogger.Companion.d("Can't get the fragment manager with this")
        }
    }
    ...
    private fun navigateToSettings() {
        try {
            ...
            activityFragmentContainer?.let {
                val transaction =
                    currentFragment.requireActivity().supportFragmentManager.beginTransaction()
                transaction.add(it.id, SettingsFragment.Companion.newInstance())
    ...
    private fun navigateToProxies() {
        try {
            ...
            activityFragmentContainer?.let {
                val transaction =
                    currentFragment.requireActivity().supportFragmentManager.beginTransaction()
                transaction.add(it.id, ProxiesFragment.Companion.newInstance())
    ...
    fun navigateToHelp() {
        try {
            ...
            activityFragmentContainer?.let {
                val transaction =
                    currentFragment.requireActivity().supportFragmentManager.beginTransaction()
                transaction.add(it.id, HelpFragment.Companion.newInstance())
    ...
    private fun navigateToBookMarks() {
        try {
            ...
            activityFragmentContainer?.let {
                val transaction =
                    currentFragment.requireActivity().supportFragmentManager.beginTransaction()
                transaction.add(it.id, BookmarksFragment.Companion.newInstance())
